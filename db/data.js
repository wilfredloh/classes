...
const seed = [
    ...
    'use classes;',
    'CREATE TABLE IF NOT EXISTS teachers (id int NOT NULL AUTO_INCREMENT, email varchar(50) NOT NULL, PRIMARY KEY (id));',
    'CREATE TABLE IF NOT EXISTS students (id int NOT NULL AUTO_INCREMENT, email varchar(50) NOT NULL, suspended boolean NOT NULL, PRIMARY KEY (id));',
